        ...
        <div class="row">
            <div class="col-sm-4 col-sm-6 single"> <!--col-sm-4 col-sm-6 single Begin-->
                <div class="product eff">
                    <a href="details.php">
                        <img class="img-responsive" src="admin_area/product_images/lining_wade_flyknit_blue_a.jpg" alt="Product 1">
                    </a>
                    
                    <div class="text">
                        <h3>
                            <a href="details.php">
                            Giày bóng rổ Li-Ning Wade Flyknit - Blue
                            </a>
                        </h3>
                        ...
                        <p class="button">
                            <a href="details.php" class="btn btn-default">Xem chi tiết</a>
            ...
            <div class="col-sm-4 col-sm-6 single"> <!--col-sm-4 col-sm-6 single Begin-->
                <div class="product eff">
                    <a href="details.php">
                        <img class="img-responsive" src="admin_area/product_images/lining_wade_flyknit_black_a.jpg" alt="Product 1">
                    </a>
                    
                    <div class="text">
                        <h3>
                            <a href="details.php">
                            Giày bóng rổ Li-Ning Wade Flyknit - Black
                            </a>
                        </h3>

                        <p class="price">2300000 VNĐ</p>
            ...
            <div class="col-sm-4 col-sm-6 single"> <!--col-sm-4 col-sm-6 single Begin-->
                <div class="product eff">
                    <a href="details.php">
                        <img class="img-responsive" src="admin_area/product_images/lining_wade_flyknit_pink_a.jpg" alt="Product 1">
                    </a>
                    
                    <div class="text">
                        <h3>
                            <a href="details.php">
                            Giày bóng rổ Li-Ning Wade Flyknit - Pink
                            </a>
                        </h3>

                        <p class="price">2200000 VNĐ</p>
